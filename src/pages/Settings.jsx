...
import { Download, Trash2, ShieldAlert, Building, Palette, Image as ImageIcon, X, Lock, Info, ExternalLink, Mail, LogOut, UserPlus, Fingerprint } from 'lucide-react';
...
const Settings = ({
  ...
  const handleExportData = () => {
    ...
    downloadAnchorNode.setAttribute("download", `samindu_backup_${new Date().toLocaleDateString()}.json`);
